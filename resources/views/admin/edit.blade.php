        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-element-list">
                    ...
                    <form method="POST" action="{{ url('editResepsionis') }}" enctype="multipart/form-data">
                        <div class="row">
                            @csrf
                            <input type="hidden" name="id" value="{{$id_resepsionis}}">
                            <!-- Form Nama -->
                            <div class="col-lg-12 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input id="nama" placeholder="Nama Resepsionis" type="text" class="form-control" name="nama_resepsionis" autocomplete="off" value="{{ $nama_resepsionis }}">
                                    </div>
                                </div>
                            </div>
                            <!-- Form Gambar -->
                            <div class="col-lg-12 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="modals-default-cl">
                                            <a data-toggle="modal" data-target="#modal">
                                                <img src="{{asset('asset')}}/{{$gambar_resepsionis}}" alt="" class="previewgambar_resepsionis">
                                            </a>
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" style="border: 2px dashed #00c292;">
                                                            <img src="{{asset('asset')}}/{{$gambar_resepsionis}}" alt="" class="modalgambar_resepsionis">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="hidden" name="gambar_lama" value="{{$gambar_resepsionis}}">
                                        <input type="file" class="custom-file-input" id="gambar_resepsionis" name="gambar_resepsionis" style="opacity: 0;" onchange="previewImg('gambar_resepsionis')" value="{{$gambar_resepsionis}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @else
                    <form method="POST" action="{{ url('editKeperluan') }}">
                        <div class="row">
                            @csrf
                            <input type="hidden" name="id_keperluan" value="{{$id_keperluan}}">
                            <!-- Form Nama -->
                            <div class="col-lg-12 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    <div class="form-ic-cmp">
                                    ...
                                    <div class="nk-int-st">
                                        <input id="nama" placeholder="Nama Keperluan" type="text" class="form-control" name="nama_keperluan" autocomplete="off" value="{{ $nama_keperluan }}">
                                    </div>
                                </div>
                            </div>
                        </div>
